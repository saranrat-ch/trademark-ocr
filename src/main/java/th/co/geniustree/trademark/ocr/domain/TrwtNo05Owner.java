...
/**
 * TrwtNo05Owner generated by hbm2java
 */

@Entity
@Table(name = "TRWT_NO05_OWNER")
public class TrwtNo05Owner extends BaseEntity implements java.io.Serializable{

    private static final long serialVersionUID = -5375243799981374077L;

    @Id
    @SequenceGenerator(name = "TRWT_NO05_OWNER_SEQ", sequenceName = "TRWT_NO05_OWNER_SEQ", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TRWT_NO05_OWNER_SEQ")
    ...
    public boolean equals(Object obj) {
        ...
        final TrwtNo05Owner other = (TrwtNo05Owner) obj;
