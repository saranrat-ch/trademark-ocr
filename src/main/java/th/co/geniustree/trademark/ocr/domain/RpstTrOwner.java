...
/**
 * RpstTrOwnerService generated by hbm2java
 */
@Entity
@Table(name = "RPST_TR_OWNER")
public class RpstTrOwner extends BaseEntity implements Serializable{

    private static final long serialVersionUID = 3627247639122706991L;

    @Id
    @SequenceGenerator(name = "RPST_TR_OWNER_SEQ", sequenceName = "RPST_TR_OWNER_SEQ", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "RPST_TR_OWNER_SEQ")
    @Column(name = "OWNER_ID", unique = true, nullable = false, precision = 22, scale = 0)
    ...
    public boolean equals(Object obj) {
        ...
        final RpstTrOwner other = (RpstTrOwner) obj;
