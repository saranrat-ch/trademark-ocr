...
// Generated Dec 12, 2013 3:11:02 PM by Hibernate Tools 3.4.0.CR1
...
/**
 * TrwtNo03Agency generated by hbm2java
 */

@Entity
@Table(name = "TRWT_NO03_AGENCY")
public class TrwtNo03Agency extends BaseEntity implements java.io.Serializable {

    private static final long serialVersionUID = 8103508275078984969L;
    @Id
    @SequenceGenerator(name = "TRWT_NO03_AGENCY_SEQ", sequenceName = "TRWT_NO03_AGENCY_SEQ", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TRWT_NO03_AGENCY_SEQ")
    ...
    public TrwtNo03Agency() {
    }

    public TrwtNo03Agency(Long agencyId) {
    ...
    public boolean equals(Object obj) {
        ...
        final TrwtNo03Agency other = (TrwtNo03Agency) obj;
