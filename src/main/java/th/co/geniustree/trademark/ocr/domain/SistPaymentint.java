...
/**
 * SistPaymentint generated by hbm2java
 */
@Entity
@Table(name = "SIST_PAYMENTINT")
public class SistPaymentint extends BaseEntity implements Serializable {

    /**
     *
     */
    private static final long serialVersionUID = 4869039236375248636L;

    @Id
    @SequenceGenerator(name = "SIST_PAYMENTINT_SEQ", sequenceName = "SIST_PAYMENTINT_SEQ", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SIST_PAYMENTINT_SEQ")
    @Column(name = "PAYINT_ID", unique = true, nullable = false, precision = 15, scale = 0)
    private Long payintId;

    @Column(name = "PAY_REF_NO", precision = 20, scale = 0)
    ...
    @Column(name = "NEW_PAY_REF_NO", precision = 20, scale = 0)
    private Long newPayRefNo;

    @Column(name = "RECV_ORG_TYPE", length = 1)
    private String recvOrgType;

    public SistPaymentint() {
    }

    public SistPaymentint(Long payintId) {
        this.payintId = payintId;
    }
    ...
    public Long getPayintId() {
        return this.payintId;
    }

    public void setPayintId(Long payintId) {
        this.payintId = payintId;
    }
    ...
    public String getRecvOrgType() {
        return recvOrgType;
    }

    public void setRecvOrgType(String recvOrgType) {
        this.recvOrgType = recvOrgType;
    }

    @Override
    public int hashCode() {
        int hash = 7;
        hash = 67 * hash + Objects.hashCode(this.payintId);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SistPaymentint other = (SistPaymentint) obj;
        if (!Objects.equals(this.payintId, other.payintId)) {
            return false;
        }
        return true;
    }
