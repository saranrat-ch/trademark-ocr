...
/**
 * SistNo04Agency generated by hbm2java
 */
@Entity
@Table(name = "SIST_NO04_AGENCY")
public class SistNo04Agency extends BaseEntity implements Serializable {

    private static final long serialVersionUID = 4447795314380887188L;

    @Id
    @SequenceGenerator(name = "SIST_NO04_AGENCY_SEQ", sequenceName = "SIST_NO04_AGENCY_SEQ", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SIST_NO04_AGENCY_SEQ")
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "TRW_AGENREC_ID")
    private TrwtNo04Agenrec trwtNo04Agenrec;

    @Column(name = "AND_OR_TYPE", length = 1)
    private String andOrType;

    public SistNo04Agency() {
    }

    public SistNo04Agency(Long agencyId, SistNo04 sistNo04) {
    ...
    public TrwtNo04Agenrec getTrwtNo04Agenrec() {
        return trwtNo04Agenrec;
    }

    public void setTrwtNo04Agenrec(TrwtNo04Agenrec trwtNo04Agenrec) {
        this.trwtNo04Agenrec = trwtNo04Agenrec;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SistNo04Agency other = (SistNo04Agency) obj;
